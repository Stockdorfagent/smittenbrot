...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      a: 'Du kannst ganz einfach per Kredit- oder Debitkarte, PayPal, Apple Pay oder Google Pay bezahlen. Die Zahlung wird sicher über Stripe abgewickelt. Abos werden über eine hinterlegte Karte abgerechnet.',
    },
    {
