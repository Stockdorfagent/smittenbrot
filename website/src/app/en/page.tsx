...
const faqs: { q: string; a: string }[] = [
  ...
  {
    q: 'How can I pay?',
    a: 'By card, PayPal, Apple Pay or Google Pay. Payment is handled securely by Stripe. Subscriptions are charged to a saved card. Payment is always in advance — cash on collection is not possible.',
  },
  {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 text-smitten-text">
      ...
      <ul className="mt-3 space-y-2 leading-relaxed">
        ...
        <li>· Pay in advance by card, PayPal, Apple Pay or Google Pay.</li>
